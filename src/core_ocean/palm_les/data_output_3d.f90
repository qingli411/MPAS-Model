...
!------------------------------------------------------------------------------!
 SUBROUTINE data_output_3d( av )
    ...
    USE arrays_3d,                                                             &
        ONLY:  alpha_T, beta_S, e, p, pt, rho_ocean, sa, solar3d, tend, u, v, w

    USE averaging

    USE control_parameters,                                                    &
        ONLY:  do3d, do3d_no, do3d_time_count, io_blocks, io_group,            &
               message_string, ntdim_3d, nz_do3d, simulated_time,              &
               time_since_reference_point, varnamelength
