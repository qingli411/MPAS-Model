       ...
       DO  i = nxl, nxr
          DO  j = nys, nyn
             ...
             DO  k = nzb+1, nzt-1
                ...
                tend(k,j,i) = tend(k,j,i) - g * 0.5_wp *                       &
                    (                                                          &
                       ( prho(k,j,i)   - prho_reference ) / prho_reference +   &
                       ( prho(k+1,j,i) - prho_reference ) / prho_reference     &
                    )
             ENDDO
          ENDDO
       ENDDO
