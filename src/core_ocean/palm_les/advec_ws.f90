...
!
!--             Calculate the divergence of the velocity field.
                div = ( ( u_comp - ( u(k,j-1,i) + u(k,j,i) ) ) * ddx           &
...
!
!--             Calculate the divergence of the velocity field.
                div = ( ( u_comp - ( u(k+1,j,i) + u(k,j,i) ) ) * ddx           &
                     +  ( v_comp - ( v(k+1,j,i) + v(k,j,i) ) ) * ddy           &
