...
!------------------------------------------------------------------------------!
 SUBROUTINE data_output_profiles
    ...
    USE control_parameters,                                                    &
        ONLY:  average_count_pr, averaging_interval_pr,   &
               dopr_n, dopr_time_count, time_since_reference_point
    ...
    USE netcdf_interface,                                                      &
        ONLY:  id_set_pr, id_var_dopr, id_var_time_pr, nc_stat,                &
...
!--                   Write data to netcdf file
                      nc_stat = NF90_PUT_VAR( id_set_pr, id_var_dopr(i),    &
                                    hom(nzb:nzt+1,1,dopr_initial_index(i)), &
                                              start = (/ 1, 1 /),              &
                                              count = (/ nzt-nzb+2, 1 /) )
...
!--       Write data to netcdf file
          nc_stat = NF90_PUT_VAR( id_set_pr, id_var_dopr(i),          &
                                  hom_sum(nzb:nzt+1,dopr_index(i)),&
