...
!------------------------------------------------------------------------------!
 SUBROUTINE check_for_restart
    ...
    USE control_parameters,                                                    &
        ONLY:  dt_restart, end_time, message_string, run_description_header,   &
               simulated_time, terminate_run, termination_time_needed,         &
               time_restart, time_since_reference_point, write_binary
